...
# ----------------------------------------
# If super_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 win32 2018.04.15.13:51:33
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/super_pll.vho"
}
